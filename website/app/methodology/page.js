      ...
      <section className="mb-12">
        ...
        <div className="rounded-lg border bg-muted/30 p-6 space-y-5 text-sm text-muted-foreground leading-relaxed">
          ...
          <div>
            ...
            <p>
              For molecules with strong multireference character — currently C₄H₄, N₂, H₆, benzene, H₈, and H₁₀ — HF canonical
          ...
          <div>
            ...
            <div className="mt-3 rounded-md bg-muted p-3 text-xs font-mono space-y-1">
              ...
              <p>ADAPT-VQE (H₂CO, C₄H₆, C₄H₄, (H₂O)₂, H₄, H₆, N₂, benzene, H₈, H₁₀) — COBYLA inner loop: max_iter=200–500, multistart=1</p>
