...
export default function sitemap() {
  ...
  const staticRoutes = [
    ...
    { route: "/pricing",      priority: 0.8, freq: "monthly" },
    { route: "/blog",         priority: 0.8, freq: "weekly"  },
    { route: "/apply",        priority: 0.7, freq: "monthly" },
    { route: "/about",        priority: 0.6, freq: "monthly" },
    { route: "/docs",         priority: 0.6, freq: "monthly" },
    { route: "/certify",      priority: 0.6, freq: "monthly" },
    { route: "/methodology",  priority: 0.5, freq: "monthly" },
  ];
