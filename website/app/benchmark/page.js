export default function BenchmarkPage() {
  const molecules = [
    ...
    { name: "LiH", status: "planned", formula: "Lithium Hydride", qubits: 12 }
  ];
  ...
  return (
    <div className="container py-16 max-w-4xl">
      ...
      <p className="text-muted-foreground mb-10">QEncode uses fixed configurations to ensure every benchmark run is reproducible and comparable.</p>
