...
# scripts/check_all.py  (REPLACE YOUR FILE WITH THIS UPDATED VERSION)
#!/usr/bin/env python3
"""
Run a company-grade consistency check for BOTH v1 and v2, with optional trusted export.
...
v2 pipeline:
  ...
  - stamp_env_v2.py (adds provenance.environment)
